<template>
    <div class="flex flex-row items-center justify-between">
          ...
          <img class="filter-white" height="20" width="20" src="../assets/svg/options-outline.svg" alt="filter_icon" />
          ...
          <img class="filter-white" height="20" width="20" src="../assets/svg/layers-outline.svg" alt="type_icon" />
